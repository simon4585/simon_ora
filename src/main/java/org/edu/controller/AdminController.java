...
public class AdminController {
	...
	public String boardList(@ModelAttribute("pageVO") PageVO pageVO, Locale locale, Model model, HttpServletRequest request) throws Exception {
		...
		/*if(pageVO.getSearchBoard_type() !=null) {
			session.setAttribute("session_bod_name", pageVO.getSearchBoard_type());
		}else
			pageVO.setSearchBoard_type((String) session.getAttribute("session_bod_name"));*/
