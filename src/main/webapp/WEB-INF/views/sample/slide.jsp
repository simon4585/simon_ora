...
body header {
	background: url(/resources/images/2.jpg) no-repeat 50% 55%;
...
body header .row #brand {
	background: url(/resources/images/logo2.png) no-repeat 0% 60%;
	height: 90px;
	width: 90px;
	margin: 0px;
	text-indent: -10000px;
...
body footer p {
	padding-top: 40px;
	padding-bottom: 40px;
	background: url(/resources/images/logo2.png) no-repeat 100% 50%;
}
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="/resources/images/asd.jpg" class="d-block w-100" alt="">

				</div>
				<div class="item">
					<img src="/resources/images/q.jpg" class="d-block w-100" alt="">
				</div>
				<div class="item">
					<img src="/resources/images/w.jpg" class="d-block w-100" alt="">
				</div>
				<div class="item">
					<img src="/resources/images/e.jpg" class="d-block w-100" alt="">
				</div>
			</div>
			<!-- <a class="left carousel-control"
				style="font-size: 40px; font-weight: bold;" " href="#carouselExampleIndicators"
				data-slide="prev" onclick="$('#myCarousel').carousel('prev')"><span class="slide_arrow">&lt;</span></a> <a class="right carousel-control"
				
				style="font-size: 40px; font-weight: bold;" " href="#carouselExampleIndicators"
				data-slide="next" onclick="$('#myCarousel').carousel('next')"><span class="slide_arrow">&gt;</span></a>
 -->
		...
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/asd.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/asd.jpg" alt="" width="620" height="416" />
					<div class="col-4">
